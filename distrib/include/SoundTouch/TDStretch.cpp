...
////////////////////////////////////////////////////////////////////////////////
//
// Last changed  : $Date: 2010/02/10 19:55:53 $
// File revision : $Revision: 1.2 $
//
// $Id: TDStretch.cpp,v 1.2 2010/02/10 19:55:53 Duncan Exp $
//
////////////////////////////////////////////////////////////////////////////////
//
// License :
...
void TDStretch::acceptNewOverlapLength(int newOverlapLength)
{
    ...
    if (overlapLength > prevOvl)
    {
        ...
        pRefMidBuffer = (SAMPLETYPE *)((((size_t)pRefMidBufferUnaligned) + 15) & (size_t)-16);
    }
}
